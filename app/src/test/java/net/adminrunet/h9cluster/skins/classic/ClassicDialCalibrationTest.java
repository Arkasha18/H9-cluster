...
public final class ClassicDialCalibrationTest {
    ...
    public void speedMatchesMeasuredMajorTicks() {
        ...
        float[] angles = {
                88.6f, 104.1f, 127.7f, 145.5f, 163.4f, 181.4f,
    ...
    @Test
    public void speedStartsAtArtworkBeginningAndReachesTwentyAtTwenty() {
        assertEquals(
                88.6f,
                ClassicDialCalibration.speedAngleDeg(0.0f),
                TOLERANCE_DEG);
        assertEquals(
                96.35f,
                ClassicDialCalibration.speedAngleDeg(10.0f),
                TOLERANCE_DEG);
        assertEquals(
                104.1f,
                ClassicDialCalibration.speedAngleDeg(20.0f),
                TOLERANCE_DEG);
    }
